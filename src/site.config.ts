...
export const theme: ThemeUserConfig = {
  ...
  description: 'The best time to plant a tree was 10 years ago. The second best time is now. ',
...
export const integ: IntegrationUserConfig = {
  ...
  links: {
    ...
    applyTip: [
      ...
      { name: 'Link', val: 'https://blog.itmt.io/' },
      { name: 'Avatar', val: 'https://cdn.itmt.io/Tomato.png' }
    ]
  },
